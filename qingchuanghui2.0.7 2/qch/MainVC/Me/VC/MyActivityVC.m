...
@interface MyActivityVC ()<UIScrollViewDelegate,SegmentDelegate>

@property (nonatomic, strong) UIScrollView *contentScrollView;
@property(nonatomic,strong)NSMutableArray *buttonList;
@property (nonatomic, weak) LYSegment *segment;
...
-(void)setSegment {
    ...
    [self buttonList];
    //初始化
    LYSegment *segment = [[LYSegment alloc]initWithFrame:CGRectMake(0,0, self.view.frame.size.width, 40*PMBWIDTH)];
...
-(void)addChildViewController{
    ...
    PublishedActivityVC *publish = [[PublishedActivityVC alloc]init];
    [self addChildViewController:publish];
    EnrollActivityVC *enroll = [[EnrollActivityVC alloc]init];
    [self addChildViewController:enroll];
}
