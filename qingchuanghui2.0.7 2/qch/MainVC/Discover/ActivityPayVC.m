...
@interface ActivityPayVC ()<UIAlertViewDelegate>{
...
- (void)viewDidLoad {
    ...
    orderNumber=[self createLabelFrame:CGRectMake(orderLabel.right, orderLabel.top, fristView.width-90*PMBWIDTH, orderLabel.height) color:[UIColor lightGrayColor] font:Font(14) text:_orderNum];
    ...
    UIView *secordView=[[UIView alloc]initWithFrame:CGRectMake(10*PMBWIDTH, fristView.bottom+10*PMBWIDTH, fristView.width, 300*PMBWIDTH)];
    ...
    UILabel *line4=[[UILabel alloc]initWithFrame:CGRectMake(line3.left, wxImageView.bottom+10*PMBWIDTH, line3.width, 1*PMBWIDTH)];
    ...
    UILabel *payLabel2=[self createLabelFrame:CGRectMake(0, line6.bottom+20*PMBWIDTH, SCREEN_WIDTH-20*PMBWIDTH, 20*PMBWIDTH) color:[UIColor blackColor] font:Font(14) text:[NSString stringWithFormat:@"需支付金额:¥%.2f元整",_price]];
