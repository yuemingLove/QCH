...
@interface MyChatViewController1 ()<UIActionSheetDelegate, UIAlertViewDelegate, RCMessageCellDelegate>

@end

@implementation MyChatViewController1
...
- (void)rightBarButtonClicked {
    if (self.conversationType == ConversationType_PRIVATE) {
        ...
        __weak MyChatViewController1 *weakSelf = self;
