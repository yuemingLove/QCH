...
-(void)commonInit {
    //按钮名称
    NSMutableArray *titleList = [[NSMutableArray alloc]initWithObjects:@"全部",@"投递",@"入驻",@"路演", nil];
...
+ (instancetype)initWithTitleList:(NSMutableArray *)titleList {
    ProjectSegment *segment = [[ProjectSegment alloc]initWithTitleList:titleList];
