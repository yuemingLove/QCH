...
# define CloseButton_Width 25 //关闭按钮宽度
...
//    [self addGestureRecognizer:tapGesture];
    ...
    closeButton.closeButtonTintColor   = TSEColor(110, 151, 245);
        ...
        [UIView animateWithDuration:.75f
             ...
             usingSpringWithDamping:0.65f
              initialSpringVelocity:0.5
                         ...
                         animations:^{
                             weakSelf.mainContainView.backgroundColor = [UIColor clearColor];
                             ...
                             weakSelf.mainContainView.frame = CGRectMake(containRect.origin.x, containRect.origin.y-40, containRect.size.width, containRect.size.height+100);
                             weakSelf.closeButton.center                 = CGPointMake(CGRectGetMaxX(weakSelf.mainContainView.frame) - weakSelf.closeButton.bounds.size.width/2,CGRectGetMinY(weakSelf.mainContainView.frame)/2+88);
                         }
        ...
        [UIView animateWithDuration:.5f
             ...
             usingSpringWithDamping:0.65f
              initialSpringVelocity:0.5
                         ...
                         animations:^{
                             CGRect containRect = weakSelf.mainContainView.frame;
                             containRect.origin.y = weakSelf.frame.size.height+20;
                             weakSelf.mainContainView.frame = containRect;
                             
                             weakSelf.closeButton.center                 = CGPointMake(CGRectGetMaxX(weakSelf.mainContainView.frame) - weakSelf.closeButton.bounds.size.width/2,weakSelf.frame.size.height+ weakSelf.closeButton.frame.size.height/2+88);
                             CGRect lineRect = weakSelf.lineView.frame;
                             lineRect.origin.y = CGRectGetMaxY(weakSelf.closeButton.frame)+20;
                             weakSelf.lineView.frame = lineRect;
