...
#define kTextSelectColor [UIColor colorWithRed:74/255.0 green:144/255.0 blue:226/255.0 alpha:1]
...
- (CGSize)calculateTitleSizeWithString:(NSString *)string
{
    ...
    CGSize size = [string boundingRectWithSize:CGSizeMake(280*SCREEN_WSCALE, 0) options:NSStringDrawingTruncatesLastVisibleLine | NSStringDrawingUsesLineFragmentOrigin | NSStringDrawingUsesFontLeading attributes:dic context:nil].size;
    return size;
}
