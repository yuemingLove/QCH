...
- (instancetype)initWithOrigin:(CGPoint)origin andHeight:(CGFloat)height {
    ...
    if (self) {
        ...
        //tableView init
        _leftTableView = [[UITableView alloc] initWithFrame:CGRectMake(origin.x, self.frame.origin.y + self.frame.size.height, ScreenWidth*0.4, 0) style:UITableViewStylePlain];
        ...
        _rightTableView = [[UITableView alloc] initWithFrame:CGRectMake(origin.x+ScreenWidth*0.4, self.frame.origin.y + self.frame.size.height, ScreenWidth*0.6, 0) style:UITableViewStylePlain];
...
- (void)animateTableViewShow:(BOOL)show complete:(void(^)())complete {
    if (show) {
        ...
        _leftTableView.frame = CGRectMake(self.origin.x, self.frame.origin.y, ScreenWidth*0.4, 0);
        [self.superview addSubview:_leftTableView];
        _rightTableView.frame = CGRectMake(self.origin.x+ScreenWidth*0.4, self.frame.origin.y, ScreenWidth*0.6, 0);
        [self.superview addSubview:_rightTableView];
        
        _leftTableView.alpha = 1.f;
        _rightTableView.alpha = 1.f;
        [UIView animateWithDuration:0.2 animations:^{
            _leftTableView.frame = CGRectMake(self.origin.x, self.frame.origin.y, ScreenWidth*0.4, _height);
            _rightTableView.frame = CGRectMake(self.origin.x+ScreenWidth*0.4, self.frame.origin.y, ScreenWidth*0.6, _height);
