...
- ( NSMutableDictionary *)sendPay_demo:(OrderModel *)model
{
    ...
    //订单标题，展示给用户
    NSString *order_name    = model.orderName;
    //订单金额,单位（分）
    NSString *order_price   = [NSString stringWithFormat:@"%@", model.orderPrice];
    ...
    NSString *orderno   = model.orderNum;
    ...
    [packageParams setObject: SP_URL        forKey:@"notify_url"];  //支付结果异步通知
