...
- (void)layoutHeaderViewForScrollViewOffset:(CGPoint)offset
{
    ...
    if (offset.y > 0)
    {
        ...
        CGFloat  alpha = 1 / kDefaultHeaderFrame.size.height * offset.y * 2;
        if (alpha > .7) {
            alpha = .7;
        }
//        NSLog(@" 1 / kDefaultHeaderFrame.size.height * offset.y * 2; =%f", 1 / kDefaultHeaderFrame.size.height * offset.y * 2 );
        self.bluredImageView.alpha = alpha;//  1 / kDefaultHeaderFrame.size.height * offset.y * 2;
