...
- (id)initWithFrame:(CGRect)frame {
    if ((self = [super initWithFrame:frame])) {
        ...
        if ([[UIImage class] instancesRespondToSelector:@selector(imageWithRenderingMode:)]) {
            ...
            SVProgressHUDErrorImage = [[UIImage imageNamed:@"SVProgressHUD.bundle/info"] imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate];
        } else {
            ...
            SVProgressHUDErrorImage = [UIImage imageNamed:@"SVProgressHUD.bundle/info"];
        }
...
- (NSTimeInterval)displayDurationForString:(NSString*)string {
    ...
    if(displayInterval<=0) displayInterval=1.0f;
